...
void CMdSpi::OnRtnDepthMarketData(CThostFtdcDepthMarketDataField *pDepthMarketData)
{
	...
	rspArgs["LastPrice"]=filterDouble(pDepthMarketData->LastPrice);
	rspArgs["PreSettlementPrice"]=filterDouble(pDepthMarketData->PreSettlementPrice);
	rspArgs["PreClosePrice"]=filterDouble(pDepthMarketData->PreClosePrice);
	rspArgs["PreOpenInterest"]=filterDouble(pDepthMarketData->PreOpenInterest);
	rspArgs["OpenPrice"]=filterDouble(pDepthMarketData->OpenPrice);
